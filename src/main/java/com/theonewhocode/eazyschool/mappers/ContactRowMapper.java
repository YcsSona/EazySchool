package com.theonewhocode.eazyschool.mappers;
...
public class ContactRowMapper implements RowMapper<Contact> {
    ...
    public Contact mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        // when the UPDATED_AT field is null then .toLocalDateTime() will throw NullPointerException
        // to avoid that do null checking
